...
requirements = python3==3.9.9,hostpython3==3.9.9,kivymd==1.1.1,PyMySQLl,kivy==2.2.1
...
presplash.filename = %(source.dir)s/data/carga.png

# (str) Icon of the application
icon.filename = %(source.dir)s/data/main_icon.png
